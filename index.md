...
- [`tg()`](https://geryan.github.io/targets.utils/reference/tg.md): why
  bother with `tar_load_globals`?
- [`te()`](https://geryan.github.io/targets.utils/reference/te.md): why
  bother with `tar_load_everything`?
- [`tl()`](https://geryan.github.io/targets.utils/reference/tl.md): why
  bother with `tar_load_globals` `tar_load_everything`?
...
- [`insert_tar_target()`](https://geryan.github.io/targets.utils/reference/insert_tar_target.md):
  why bother with `tar_target(name = , commmand = )`. WTF that’s barely
  any shorter?
...
- [`tar_terra_nested()`](https://geryan.github.io/targets.utils/reference/tar_terra_nested.md):
  Create a target with nested spatial `terra` objects
...
Navigate your pipeline dependencies with
[`tar_downstream()`](https://geryan.github.io/targets.utils/reference/tar_downstream.md)
and
[`tar_upstream()`](https://geryan.github.io/targets.utils/reference/tar_upstream.md)
...
Handling nested spatial data with
[`tar_terra_nested()`](https://geryan.github.io/targets.utils/reference/tar_terra_nested.md)
...
objects, but chokes on lists containing nested spatial objects.
[`tar_terra_nested()`](https://geryan.github.io/targets.utils/reference/tar_terra_nested.md)
fills that gap by recursively finding and managing nested spatial
formats buried inside arbitrary R objects. How recursive? How arbitrary?
Try me. I’ll probably break.
...
objects with custom formats that write to GeoTIFF and GeoPackage.
